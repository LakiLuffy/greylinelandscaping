  ...
  return (
    <section className="bg-[#3f5637] px-5 py-16 pb-28 text-white" id="contact-form">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
        <div>
          <h2 className="text-3xl font-black sm:text-4xl">Get a Free Landscaping Quote in {suburbName}</h2>
          <p className="mt-4 text-white/86">Or call us directly</p>
          ...
          <p className="mt-6 text-sm leading-6 text-white/78">
            Servicing {suburbName}, {nearbySuburbs[0]}, {nearbySuburbs[1]}, and the wider Bayside area.
          </p>
        </div>
        <form className="grid gap-4 rounded-lg bg-white p-5 text-[#2D2D2D] shadow-xl sm:grid-cols-2" onSubmit={handleSubmit}>
          ...
          <p className="text-sm text-[#606060] sm:col-span-2" aria-live="polite">{status}</p>
        </form>
      </div>
    </section>
  );
